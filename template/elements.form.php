...
<head>
    ...
    <link rel="stylesheet" href="template/assets/css/bootstrap-timepicker.min.css" />
    <link rel="stylesheet" href="template/assets/css/daterangepicker.min.css" />
    <link rel="stylesheet" href="template/assets/css/bootstrap-datetimepicker.min.css" />
    <link rel="stylesheet" href="template/assets/css/bootstrap-colorpicker.min.css" />
...
<script src="template/assets/js/bootstrap-timepicker.min.js"></script>
<script src="template/assets/js/moment.min.js"></script>
<script src="template/assets/js/daterangepicker.min.js"></script>
<script src="template/assets/js/bootstrap-datetimepicker.min.js"></script>
<script src="template/assets/js/bootstrap-colorpicker.min.js"></script>
<script src="template/assets/js/jquery.knob.min.js"></script>
<script src="template/assets/js/autosize.min.js"></script>
<script src="template/assets/js/jquery.inputlimiter.min.js"></script>
<script src="template/assets/js/jquery.maskedinput.min.js"></script>
<script src="template/assets/js/bootstrap-tag.min.js"></script>
